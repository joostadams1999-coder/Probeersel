...
TRANSLATIONS = {
    ...
    "en": {
        ...
        "your_qualities": "Your capabilities:",
...
# --- 1. CONFIGURATIE ---
QUALITEITEN = {
    "1.1": {"naam": "Mobiliseren van actoren", "naam_en": "Mobilizing actors", "groep": "Absorptief", "kleur": "rgba(255, 165, 0, 0.8)"},
    "1.2": {"naam": "Integratie van kennis", "naam_en": "Knowledge integration", "groep": "Absorptief", "kleur": "rgba(255, 165, 0, 0.8)"},
    "1.3": {"naam": "Benadrukken van kleine successen", "naam_en": "Emphasizing small successes", "groep": "Absorptief", "kleur": "rgba(255, 165, 0, 0.8)"},
    "1.4": {"naam": "Concretiseren van ambities", "naam_en": "Concretizing ambitions", "groep": "Absorptief", "kleur": "rgba(255, 165, 0, 0.8)"},
    "1.5": {"naam": "Framen van innovatie in context", "naam_en": "Framing innovation in context", "groep": "Absorptief", "kleur": "rgba(255, 165, 0, 0.8)"},
    "2.1": {"naam": "Verifiëren waarde in pilot", "naam_en": "Verifying value in pilot", "groep": "Adoptief", "kleur": "rgba(100, 149, 237, 0.8)"},
    "2.2": {"naam": "Verifiëren waarde contexten", "naam_en": "Verifying value contexts", "groep": "Adoptief", "kleur": "rgba(100, 149, 237, 0.8)"},
    "2.3": {"naam": "Testen beheersbaarheid", "naam_en": "Testing manageability", "groep": "Adoptief", "kleur": "rgba(100, 149, 237, 0.8)"},
    "2.4": {"naam": "Overzicht bewaren", "naam_en": "Maintaining overview", "groep": "Adoptief", "kleur": "rgba(100, 149, 237, 0.8)"},
    "2.5": {"naam": "Momentum creëren ecosysteem", "naam_en": "Creating momentum ecosystem", "groep": "Adoptief", "kleur": "rgba(100, 149, 237, 0.8)"},
    "2.6": {"naam": "Leren van algemene lessen", "naam_en": "Learning from general lessons", "groep": "Adoptief", "kleur": "rgba(100, 149, 237, 0.8)"},
    "2.7": {"naam": "Iteratief leren in innovatie", "naam_en": "Iterative learning in innovation", "groep": "Adoptief", "kleur": "rgba(100, 149, 237, 0.8)"},
    "3.1": {"naam": "Coördinatie adaptie", "naam_en": "Coordination adaptation", "groep": "Adaptief", "kleur": "rgba(255, 215, 0, 0.8)"},
    "3.2": {"naam": "Aanpassen routines", "naam_en": "Adjusting routines", "groep": "Adaptief", "kleur": "rgba(255, 215, 0, 0.8)"},
    "3.3": {"naam": "Creëer ondersteunend beleid", "naam_en": "Create supportive policy", "groep": "Adaptief", "kleur": "rgba(255, 215, 0, 0.8)"},
    "3.4": {"naam": "Verzeker gelijk speelveld", "naam_en": "Ensure level playing field", "groep": "Adaptief", "kleur": "rgba(255, 215, 0, 0.8)"},
    "3.5": {"naam": "Vergaar waarde lange tijd", "naam_en": "Gather value long term", "groep": "Adaptief", "kleur": "rgba(255, 215, 0, 0.8)"}
}
...
if team_responses:
    ...
    for _, row in df.iterrows():
        ...
        fig1.add_trace(go.Scatter(
            ...
            name=row['groep'], hovertemplate=f"<b>{t('quality')} {row['id']}</b><br>{get_quality_name(row['id'], st.session_state.get('language', 'nl'))}<br>{t('number')}: {row['count']}<extra></extra>"
        ))
